...
# ------------------------------------------setting the window------------------------------------------
root = Tk()
root.title("FILES SORTING APPLICATION | DEVELOPED BY SABYASACHI")
root.geometry("1500x750+0+0")
root.resizable(False, False)
root.config(bg="white")

# ------------------------------------------title------------------------------------------
lbl_title = Label(root, text="FILES SORTING APPLICATION BY SM", padx = 10, compound= LEFT, font=("times new roman", 40, "bold"), bg="crimson",
                  fg="white", anchor="w")
...
# ------------------------------------------file showing frame------------------------------------------
files_frame = Frame(root, bd=1, relief=SOLID, bg="white")
files_frame.place(x=20, y=350, width=1460, height=240)

total_files_label = Label(files_frame, text="Total Files: ", font=("times new roman", 30, "bold"), bg="white",
                          fg="black")
...
# ------------------------------------------buttons------------------------------------------
browse_button = Button(root, text="Browse Folder", font=("times new roman", 15, "bold"), bg="brown", fg="white",
                       activebackground="brown", activeforeground="white", command=browse_folder)
...
start_button = Button(root, text="START", font=("times new roman", 15, "bold"), bg="green", fg="yellow",
                      activebackground="green", activeforeground="yellow", state=DISABLED, command=start_function)
